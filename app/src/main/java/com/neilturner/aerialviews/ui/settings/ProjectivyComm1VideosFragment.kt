...
class ProjectivyComm1VideosFragment : MenuStateFragment() {
    override fun onCreatePreferences(
        ...
        setPreferencesFromResource(R.xml.settings_projectivy_comm1_videos, rootKey)
    ...
    private fun setupQualityPreference() {
        MediaPreferenceHelper.setupQualityWithDataUsage(
            fragment = this,
            qualityPrefKey = "projectivy_comm1_videos_quality",
    ...
    private fun updateSummary() {
        val sceneType = findPreference<MultiSelectListPreference>("projectivy_comm1_videos_scene_type")
        ...
        val timeOfDay = findPreference<MultiSelectListPreference>("projectivy_comm1_videos_time_of_day")
