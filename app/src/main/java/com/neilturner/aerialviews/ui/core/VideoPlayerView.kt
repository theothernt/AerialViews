...
class VideoPlayerView @OptIn(UnstableApi::class)
@JvmOverloads constructor(
    ...
    //override fun seekTo(pos: Int) = exoPlayer.seekTo(pos.toLong())

    //override fun isPlaying(): Boolean = exoPlayer.playWhenReady

    //override fun getBufferPercentage(): Int = exoPlayer.bufferedPercentage
    ...
    //override fun getAudioSessionId(): Int = exoPlayer.audioSessionId
