...
//        }
    ...
    fun setSvgResource(resId: Int) {
        ...
        if (drawable != null) {
            ...
            androidx.core.graphics.drawable.DrawableCompat.setTint(originalDrawable!!, android.graphics.Color.WHITE)
    ...
    override fun onDraw(canvas: android.graphics.Canvas) {
        ...
        canvas.withTranslation(adjustedDx, adjustedDy) {
            ...
            androidx.core.graphics.drawable.DrawableCompat.setTint(drawable, shadowColor)
