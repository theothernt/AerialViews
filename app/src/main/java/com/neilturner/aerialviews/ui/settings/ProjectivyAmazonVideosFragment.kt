...
class ProjectivyAmazonVideosFragment : MenuStateFragment() {

    override fun onCreatePreferences(
        savedInstanceState: Bundle?,
        rootKey: String?,
    ) {
        setPreferencesFromResource(R.xml.settings_projectivy_amazon_videos, rootKey)
    ...
    private fun setupQualityPreference() {
        MediaPreferenceHelper.setupQualityWithDataUsage(
            fragment = this,
            qualityPrefKey = "projectivy_amazon_videos_quality",
    ...
    private fun updateSummary() {
        val sceneType = findPreference<MultiSelectListPreference>("projectivy_amazon_videos_scene_type")
        ...
        val timeOfDay = findPreference<MultiSelectListPreference>("projectivy_amazon_videos_time_of_day")
